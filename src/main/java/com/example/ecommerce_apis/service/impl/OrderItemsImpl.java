...
//    }
    ...
    public OrderItemsModel addOrderItem(OrderItemsModel orderItemsModel) {
        ...
        OrderModel orderModel = orderService.getOrder(orderItemsModel.getOrder().getId());
        if(productModel.isActive() && productModel.getQuantity() >= orderItemsModel.getQuantity() && orderModel.getStatus().equals("Draft")) {
